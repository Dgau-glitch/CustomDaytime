...
"minecraft:overworld" {
  ...
  # Night acceleration multiplier when 100% of players sleep
  # The plugin scales this value by sleeping player percentage: 50% sleeping with 300.0 gives 150x.
  # Default: 300.0
  fullSleepAccelerationMultiplier=300.0
}
```
